...
function SphereGeo({
  ...
  useFrame((_state, delta) => {
    if (!isActive) return;
    // Limit delta to improve performance
    ...
    <div className="techstack">
      ...
      <Canvas
        ...
        onCreated={(state) => {
          ...
          // Set pixel ratio to a lower value for better performance
          state.gl.setPixelRatio(Math.min(1.5, window.devicePixelRatio));
        }}
      ...
      >
        ...
        />
        {/* Removed EffectComposer for better performance */}
      </Canvas>
    </div>
  );
};
